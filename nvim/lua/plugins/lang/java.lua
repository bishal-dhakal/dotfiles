...
-- Provides full Java IDE features: code completion, refactoring, debugging, and testing
...
return {
  ...
  opts = function()
    ...
    -- Add Lombok support if available via Mason
    ...
    return {
      root_dir = function(path)
        return vim.fs.root(path, { ".git", "pom.xml", "build.gradle", "settings.gradle", ".project", ".classpath" })
      end,
  ...
  config = function(_, opts)
    ...
    local function attach_jdtls()
      ...
      local config = opts.jdtls and vim.tbl_deep_extend("force", base_config, opts.jdtls) or base_config
